...
function EditProfilePage() {
  ...
  const editReservation = () => {
    ...
    params.append("myDate", fields.checkInDate);
    params.append("myDate2", fields.checkOutDate);
    params.append("roomtype", parseInt(fields.room_typeId));

    api
      .post(`/profile/edit-book/${id}`, params)
      .then(() => {
        setFields({});
